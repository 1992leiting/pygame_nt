...
SK_物攻技能 = ["天命剑法","致命","理直气壮","牛刀小试","剑荡四方","长驱直入","翻江搅海","惊涛怒","浪涌","天崩地裂","断岳势","裂石","满天花雨","破血狂攻","破碎无双","弱点击破","善恶有报","惊心一剑","壁垒击破","死亡召唤","横扫千军","狮搏","象形","连环击","鹰击","烟雨剑法","飘渺式","天雷斩","裂石","断岳势","天崩地裂","浪涌","惊涛怒","力劈华山","高级连击","破釜沉舟"]
